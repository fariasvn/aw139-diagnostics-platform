...
// Store Python server processes
let ragProcess: ChildProcess | null = null;
let crewProcess: ChildProcess | null = null;
...
function startPythonServers() {
  ...
  // Start CrewAI on port 9000 (after a short delay)
  setTimeout(() => {
...
// Start Python servers when module loads
startPythonServers();
